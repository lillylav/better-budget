...
request.onupgradeneeded = function(event) {
    ...
    // create an object store (table) called `better_budget`, set it to have an auto incrementing primary key of sorts 
    db.createObjectStore('better_budget', { autoIncrement: true });
};
